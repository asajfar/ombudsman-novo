...
<?php
	...
	$image = get_string_between($str, "[img]", "[/img]");
	      ...
	      $title = "<title>".$header_title."</title>\n";
	       ...
	       $title = "<title>ПУБЛИКАЦИЈЕ :: Покрајински заштитник грађана - омбудсман</title>\n";
	    }
 ?>
...
<head>
	...
	<meta name="description" content="Публикације Покрајинског заштитника грађана - омбудсмана :: Publikacije Pokrajinskog zaštitnika građana - ombudsmana" />
							...
							<div class="col-md-8">
								<div class="row">
									<div class="sva-istrazivanja">
										<h3 class="sva-istrazivanja-header">ПУБЛИКАЦИЈЕ ПОКРАЈИНСКОГ ЗАШТИТНИКА ГРАЂАНА - ОМБУДСМАНА</h3>
									</div>
								</div>
								<div class="row">
									<?php
								        $number = 12;
								        $template = "Publikacije";
								    	$category = "5";
									...
									<div class="najnovije-vesti-right">
										<div class="col-md-12 najnovije-vesti-modul">
											<div class="najnovije-vesti-naslov">
												<span>НАЈНОВИЈЕ ПУБЛИКАЦИЈЕ</span>
											</div>
