...
<head>
	<title>Покрајински заштитник грађана - омбудсман ::: Систематизација и организација</title>
							...
							<div class="col-md-12">
								<div class="deo-teksta">
									<div class="naslov-artikla">
										<h2 id="faq">СИСТЕМАТИЗАЦИЈА И ОРГАНИЗАЦИЈА</h2>
									</div>
									<div class="toogle-box faq-box">
										<div class="toogle-elem active">
											<div class="toogle-title">
												<h2 class="fontaccess"><a class="toogle-link" href="#"></a>СИСТЕМАТИЗАЦИЈА</h2>
											</div>
											<div class="toogle-content">
												<p class="fontaccess">Правилник о унутрашњој организацији и систематизацији радних места у Стручној служби Ппокрајинског зашттитника грађана - омбудсмана (<a style="font-weight: 700;" href="../sr/doc/dokumenti/sistematizacija/pravilnik-sistematizacija-13062022.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> 1.4 мегабајта</a>)</p><br>
												<!-- <p class="fontaccess">Правилник о изменама и допунама Правилника о унутрашњој организацији и систематизацији радних места у Стручној служби Покрајинског заштитника грађана - омбудсмана (14.01.2020.) (<a style="font-weight: 700;" href="../sr/doc/dokumenti/sistematizacija/Izmena-dopuna-pravilnik-14012020.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> 1.7 мегабајта</a>)</p>
												<p class="fontaccess">Правилник о изменама и допунама Правилника о унутрашњој организацији и систематизацији радних места у Стручној служби Покрајинског заштитника грађана - омбудсмана (12.01.2021.) (<a style="font-weight: 700;" href="../sr/doc/dokumenti/sistematizacija/Izmena-dopuna-pravilnik-12-01-2021.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> 1.2 мегабајта</a>)</p> -->
											</div>
										</div>

										<div class="toogle-elem">
											<div class="toogle-title">
												<h2 class="fontaccess"><a class="toogle-link" href="#"></a>ОРГАНИЗАЦИЈА</h2>
											</div>
											<div class="toogle-content">
												<p class="fontaccess"><img style="width: 100%;" src="../sr/doc/dokumenti/sistematizacija/org-struktura-12012021.jpg" alt="Dijagram organizacije"></p>
											</div>
										</div>
									</div>
								</div>
