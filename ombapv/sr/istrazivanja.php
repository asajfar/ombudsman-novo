...
<?php
	...
	$image = get_string_between($str, "[img]", "[/img]");
	      ...
	      $title = "<title>".$header_title."</title>\n";
	       ...
	       $title = "<title>ИСТРАЖИВАЊА | Покрајински заштитник грађана - омбудсман</title>\n";
	    }
 ?>
...
<head>
	...
	<meta name="description" content="Истраживања Покрајинског заштитника грађана - омбудсмана" />

	<link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
	<link rel="canonical" href="https://www.ombudsmanapv.org/riv/index.php/istrazivanja.html" />
	...
	<script type="application/ld+json">
	{
	  ...
	  "@type" : "Product",
	  "name" : "ИСТРАЖИВАЊА",
	  "image" : [ "https://www.ombudsmanapv.org/ombapv/cnews/uploads/naslovna-istrazivanje-NM-mala.jpg", "http://ombudsmanapv.org/ombapv/cnews/uploads/2018-12-28_Istrazivanje-bolnicko-lecenje.jpg" ],
	  "brand" : {
	    "@type" : "Brand",
	    "name" : "Покрајински заштитник грађана - ОМБУДСМАН",
	    "logo" : "https://www.ombudsmanapv.org/ombapv/sr/images/logo/ombudsman-logo.png"
	  }
	}
	</script>
				...
				<div class="container">
					<div class="zivot-box">
						<div class="row sticky-parent-element-1">
							<div class="col-md-8">
								<div class="row">
									<div class="sva-istrazivanja">
										<h3 class="sva-istrazivanja-header">ИСТРАЖИВАЊА</h3>
									</div>
								</div>
								<div class="row">
									<?php
								        $number = 12;
								        $template = "Istrazivanje";
								    	$category = "4";
									...
									<div class="najnovije-vesti-right">
										<div class="col-md-12 najnovije-vesti-modul">
											<div class="najnovije-vesti-naslov">
												<span>NAJNOVIJA ISTRAŽIVANJA</span>
											</div>
