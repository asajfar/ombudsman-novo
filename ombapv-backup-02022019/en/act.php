...
<head>
	<title>FOUNDING ACT :: THE PROVINCIAL PROTECTOR OF CITIZENS - OMBUDSMAN</title>
	...
	<script type="application/ld+json">
	{
	  ...
	  "@type" : "LocalBusiness",
	  "name" : "FOUNDING ACT :: The Provincial Protector of Citizens - Ombudsman",
	  ...
	  "url" : "http://www.ombudsmanapv.org/ombapv/en/act.php"
	}
	</script>
					...
					<div class="zivot-box">
						<div class="row sticky-parent-element-1">
							<div class="col-md-8">
								<div class="row akt">
									<div class="akt-naziv">
										<h3 class="akt-naziv-header">FOUNDING ACT</h3>
									</div>
								</div>
								<div class="row akt">
								...
								<div class="download">
									<a href="../sr/doc/dokumenti/Pso_o_Pokrajinskom_zastitniku_gradjana-ombudsmanu.pdf" target="_blank">Download the document <span class="CyrLatIgnore">:: pdf :: 1.5MB</span> <span class="strelice">>>></span></a>
								</div>
							</div>
							<div class="col-md-4">								
										...
										<div class="col-md-12 najnovije-vesti-modul">
											...
											<div class="najnovije-vesti-links">
												<ul class="najnovije-vesti-lista">
													<li class="active"><a class="isdisabled" href="act.php">Founding act</a></li>
