...
<head>
	<title>Покрајински заштитник грађана - омбудсман :: НАЈНОВИЈЕ ВЕСТИ</title>
	...
	<script type="text/javascript" src="js/plugins-scroll.js" defer></script>
	...
	<script type="text/javascript" src="js/cyrlatconverter_ignore_list_rs.js" async></script>
	<script type="text/javascript" src="js/cyrlatconverter.js" async=""></script>
		...
		<div class="naslovna-content" id="content">
			...
			<div class="section-content services-section">
				...
				<div class="services-box1">
					<div class="container vesti-index">
						<div class="row">

							<div class="col-md-9">
								<div class="novo">
									<div class="triggerAnimation animated" data-animate="fadeInRight">
										<div class="naslov-vesti-index">
											<h2 id="naslov-vesti-index">НАЈНОВИЈЕ ВЕСТИ</h2>
										</div>
							...
							<div class="col-md-3 sidebar-border">
								<aside class="sidebar-advanced">
									...
									<div class="radno-vreme">
										<h3>Радно време</h3>
										<div><p style="font-weight: bold">Пон-Пет: 08.00 - 16.00</p></div>
										<div><p>Булевар Михајла Пупина 25<br>Зграда Воде Војводине (Бивша ДТД)<br>21101 Нови Сад<p></p></div>
										<div><p><i class="fa fa-phone"></i>021/487-41-44<br><i class="fa fa-phone"></i>021/55-77-27<br><i class="fa fa-fax"></i>021/487-41-44</p></div>
										<div><p style="padding-right: 10px;" class="CyrLatIgnore"><i class="fa fa-envelope-o "></i>office@ombudsmanapv.org</p></div>
									</div>
...
<!-- Skripta koja po ucitavanju stranice dodaje klasu .vesti-slika elementu .vest a. Ovo se radi yato sto jenemoguce ovu klasu dodati u templejtu u CuteNews-u ([full-link]Опширније...[/full-link])-->
<script>
